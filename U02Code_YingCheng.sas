...
%let ME =  Ying.Cheng;
%let path=/sscc/home/y/ycz2372/sasuser.v94/Predict411/Insurance Assignment;
libname IHW  "&path";
...
model TARGET_FLAG( ref="0" ) = 
					...
					No_CLM_FREQ  
					No_HOME 
					log_INCOME No_Income 
					log_OLDCLAIM  No_OLDCLAIM 
					No_HOMEKIDS 
					No_KIDSDRIV
					log_BLUEBOOK 
					IMP_AGE
					...
					IMP_YOJ 
					log_TRAVTIME 
					CAR_TYPE_MV        CAR_TYPE_PS
					CAR_USE_C 
					HighEducation     LowEducation 
					JOB_WHITE_COLLAR         JOB_BLUE_STUDENT 
					MSTATUS_Y 
					PARENT_Y 
					RED_CAR_Y 
					REVOKED_Y 
...
libname HW "/sscc/home/y/ycz2372/sasuser.v94/Predict411/Insurance Assignment";
